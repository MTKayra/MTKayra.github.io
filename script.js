...
<head>
  ...
  <meta name="description" content="MT KAYRA - Savunma Teknolojilerinde Geleceği Şekillendiriyoruz">
...
<body>
  <nav>
    <div class="nav__logo"><a href="#">MT <span>KAYRA</span></a></div>
    <div class="nav__links">
      <a href="#about" class="nav__link">Hakkımızda</a>
      <a href="#projects" class="nav__link">Projeler</a>
  ...
  <header>
    ...
    <div class="section__container header__container">
      <div class="header__content">
        <h1>
          <span>MT</span>
          <span style="color: #f2480b;">KAYRA</span>
          <span>TEAM</span>
        </h1>
        <h2 class="section__title">
          Savunma Teknolojilerinde <span>Geleceği Şekillendiriyoruz</span>
        </h2>
        <p>
        ...
        <div class="action__btns">
          ...
          <a href="https://github.com/mtkayra" class="video" target="_blank" rel="noopener">
            <div class="video__icon">
              <i class="fab fa-github"></i>
            </div>
            <span>GitHub Profilimiz</span>
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="section__container about__container">
      <div class="about__content">
        ...
        <div class="team__info">
          ...
          <div class="team__section">
            <h3>Takım Hedefleri</h3>
            <ul>
              <li><i class="fas fa-flag"></i> Teknofest 2025'te başarılı olmak</li>
              <li><i class="fas fa-lightbulb"></i> Yenilikçi çözümler geliştirmek</li>
              <li><i class="fas fa-handshake"></i> Endüstriyel işbirlikleri kurmak</li>
              <li><i class="fas fa-graduation-cap"></i> Genç mühendisleri desteklemek</li>
            </ul>
          </div>
        </div>
        <div class="skills">
  ...
  <section class="project" id="projects">
    <div class="section__container project__container">
      <p class="section__subtitle">Projelerimiz</p>
      <h2 class="section__title"><span>Son</span> Projelerimiz</h2>
